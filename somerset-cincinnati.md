...
Somerset's visual language pulls from real places: towering doors commissioned in India, a repurposed Italian tram car for seating, and a garden that's been documented with 500+ live plants. The Lounge isn't "library-themed"—it's a functioning lending library that regulars actually borrow from.

## When Somerset is the right call

- **After-ceremony or rehearsal-night parties** that want atmosphere without a sit-down dinner. Book the Lounge and add a garden nook for fresh air.
- **Team mixers and client socials** where good lighting, serious cocktails, and non-alcoholic options matter more than a plated meal.
- **Meetups and mission-driven gatherings** that can benefit from the community policy.
- **Photoshoots** that need the conservatory light or the Lounge texture; dedicated booking is available.
...
- **Phone:** (513) 270-5982
- **Spaces:** Conservatory bar (greenhouse), Lounge (library bar), outdoor garden with reservable nooks and an open-air kitchen bus
- **Bookings:** Lounge 20–45 (approx. 30 seated); garden gazebo 8–12; larger configurations by request
- **Policies:** no private ticketed events; reservations hold the space (no table service); one booking per space per day; standard hold is 4 hours
- **Hours & HH:** Mon–Tue 4–12; Wed–Fri 4–2; Sat 2–2; Sun 2–12 • Weekday happy hour 4–7 pm, $2 off core drinks
- **Parking:** free street parking; pay lot at Rothenberg Academy (2-minute walk)

---

**See also:** [Somerhaus Cincinnati | Event Space in Over-the-Rhine](somerhaus-cincinnati)  
[← Back to index](index)
